...
###### Checking out the current state of the app. Now if you choose the same colors/Icon as me your app should look something like this. Otherwise it may be slightly different.
